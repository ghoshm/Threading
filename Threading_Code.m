...
% Logical Table 
common_table = zeros(size(uniqueSeqs{1,1},1),size(gFreq,1),'single'); 
...
%% Statistical Comparisons of Frequencies 
...
data = squeeze(gFreq_merge{1,1}(s,time_window{set_token}(1):time_window{set_token}(2),...
